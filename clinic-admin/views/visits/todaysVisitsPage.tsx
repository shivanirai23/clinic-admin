...
import { todayVisits } from "@/lib/mock-data";
            ...
            <tbody>
              {pageItems.map((visit) => (
                <tr key={visit.id} className="border-b border-border last:border-b-0">
                  ...
                  <td className="px-5 py-4 text-sm text-text-secondary">{visit.veterinarian}</td>
                  <td className="px-5 py-4 text-sm text-text-secondary">{visit.reason}</td>
                  <td className="px-5 py-4 text-sm font-semibold text-text-primary">{visit.time}</td>
                </tr>
              ))}
            </tbody>
          </table>
